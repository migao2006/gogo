...
## 1.1.1 deployment hotfix

The package lock now uses the public npm registry (`https://registry.npmjs.org/`) so Vercel can install dependencies. Do not upload a lockfile generated with a private or internal registry URL.
